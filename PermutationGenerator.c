...
void generateRandomPermutation(int *arr, int n) //O(n^2)
{
    cyclesCounter = 1; 
    int result[n + 1];
    for (int i = 0; i <= n; i++)
...
void generateRandomPermutation2(int *arr, int n) //O(n)
{
    ...
    { 
        ...
        swap(notUsed,nextIndex,sizeOfNotUsed-1);
        sizeOfNotUsed--;
...
int main()
{
    ...
    // generateRandomPermutation2(arr,n);
    // generateRandomPermutation(arr,n);
